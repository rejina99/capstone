...
export default function CreateListing() {
    ...
    return (
        <main className="p-3 max-w-4xl mx-auto">
            <h1 className="text-3xl font-semibold text-center my-7">Upload Your Post</h1>
            ...
            <form className="flex flex-col sm:flex-col" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col gap-4 flex-1">
                    ...
                    <div className="flex gap-6 flex-wrap">
                        ...
                        <div className=" flex items-center gap-2">
                            <input className=" p-3 border border-gray-300 rounded-lg" type="number" id="regularPrice" min='100' max='10000000' onChange={handleChange} value={formData.regularPrice} required />
                            <p>Regular Price</p>
                        ...
                        {formData.offer && (
                            <div className=" flex items-center gap-2">
                            <input className=" p-3 border border-gray-300 rounded-lg" type="number" id="discountPrice" min='100' max='10000000' onChange={handleChange} value={formData.discountPrice} required />
                ...
                <button className="p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-60">{loading ? 'Creating...' : 'Create Post'}</button>
